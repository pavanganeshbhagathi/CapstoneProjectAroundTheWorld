...
@Component({
  selector: 'app-worldtripsearchbyrating',
  templateUrl: './worldtripsearchbyrating.component.html',
  styleUrls: ['./worldtripsearchbyrating.component.css']
})
export class WorldtripsearchbyratingComponent implements OnInit {
